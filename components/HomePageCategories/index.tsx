    ...
    return (
        <View className="w-auto mt-7">
            <View className="w-auto flex-row flex nowra justify-between">
                ...
                <TouchableOpacity onPress={() => router.push(`/product/${category}`)} ><Text className="font-bold text-[#7867BE] text-sm underline ">See all</Text></TouchableOpacity>
            </View>
            <View className="flex justify-between mt-2">
                <View className="flex justify-between flex-row">
                    {loading ?
                        <>
                            <View className="w-[160px] h-[160px] bg-[#D9D9D9] rounded-[10px] animate-pulse"></View>
                            <View className="w-[160px] h-[160px] bg-[#D9D9D9] rounded-[10px] animate-pulse"></View>
                        </>
                        :
