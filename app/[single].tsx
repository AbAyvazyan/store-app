      ...
      {loading ? (
        ...
        <>
          <View className="w-[90%] mx-auto mt-10">
            <Slider
              sliders={product.images.map((imageUrl, index) => ({
                id: index + 1,
                img: imageUrl,
              }))}
            />
            ...
            <View>
              <Text className="text-[#1E1D1D] text-[17px] font-medium uppercase mt-6">
                {product.title}
              </Text>
              ...
              <View className="flex gap-5 flex-row items-center pt-2">
                <Text className="text-[#1E1D1D] text-[15px] font-normal">
                  Rating
                </Text>
          ...
          <View className="w-full min-h-[150px] p-[20px] border-t-[1px] border-b-[1px] border-[#E6E6E6] my-[25px]">
            <Text className="text-[#8F8F8F] text-[14px] font-light">
              {product.description}
            </Text>
          </View>
          ...
          <View className="flex flex-row justify-between w-[90%] mx-auto">
            <View>
              <Text className="text-[#777777] text-[15px] font-normal mb-2">
                Total
              </Text>
              <Text className="text-[#1E1D1D] text-[19px] font-medium">
                {Math.floor(
