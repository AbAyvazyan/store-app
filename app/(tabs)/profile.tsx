  ...
  return (
    <SafeAreaView className="h-full w-full">
      ...
      <View className="flex flex-row gap-6 mt-3 mx-3 border-b-2 border-b-[#E6E6E6] pb-4">
        ...
        <View>
          <Text className="text=[19px] text-[#1E1D1D] font-normal mt-2">
            {userData.firstName} {userData.lastName}
          </Text>
          <Text className="text=[15px] text-[#ADADAD] font-light capitalize mt-2">
            {userData.gender}
          </Text>
        </View>
      </View>
      ...
      <View className="w-full border-b-2 px-[25px] border-b-[#E6E6E6] border-t-2 border-t-[#E6E6E6] py-4 absolute bottom-0">
        ...
        >
          <View className="flex flex-row gap-5 items-center">
            ...
            <Text className="text-[14px] text-[#1E1D1D] font-light">
              Log Out
            </Text>
          </View>
